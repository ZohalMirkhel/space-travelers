  ...
  return (
    <>
      <tr className={`${rowClass} sm:table-row hidden sm:flex`}>
        ...
        <td className="px-6 py-2 border text-base sm:w-1/6 w-full">
          <div className="flex justify-start">
            <span className={`px-4 py-1 rounded text-sm ${
              mission.reserved ? 'bg-[#5F9EA0] text-white' : 'bg-gray-500 text-white'
            }`}>
